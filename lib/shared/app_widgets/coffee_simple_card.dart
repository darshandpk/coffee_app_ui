...
class CoffeeSimpleCard extends StatelessWidget {
  ...
  const CoffeeSimpleCard({super.key, required this.coffeeModel, required this.heroTag});

  @override
  Widget build(BuildContext context) {
    return GestureDetector(
      onTap: () {
        context.push(AppRoutes.prodDetails, extra: coffeeModel);
      },
      child: Container(
        width: 180.w,
            ...
            children: [
              ...
              Row(
                ...
                children: [
                  ...
                  //   ),
                  //   child: Center(
                  //     child: Icon(Icons.add, color: AppColors.kCaramel),
                  //   ),
                  // ),
                ],
              ),
